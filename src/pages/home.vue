<template>
  <div class="topbar">
    <div class="header">
      ...
      <div class="right">
        <img class="useravatar" src="../assets/img/user.png" alt="">
        <a>
          甲乙丙丁
        ...
        <a href="javascript:void(0)">
          <i @click="show=1"  class="logout iconfont icon-tuichu" title="退出"></i>
        </a>
      </div>
    </div>
    <div class="main">
      <div class="main-left">
        <ul>
          ...
          <li class="list list2">
            ...
            <div class="subdiv">
              <router-link class="list-a " href="" :to="list[7].path">
                短息服务
                 </router-link>
                 <router-link class="list-a " href="" :to="list[8].path">
                语音服务
                 </router-link>
              <!-- <a href="">短息服务</a>
              <a href="">语音服务</a> -->
    ...
    <!-- <div class="footer">
      ...
      <!-- 遮罩层 -->
        <div   v-show="show==1"  class="Masked"></div>
        <!-- 退出提示框 -->
        <div v-show="show==1" class="quit">
      ...
      tableData: [
        {
          date: "01",
          name: "王小虎",
          buyingTime: "2018-09-03 13:22:50",
          expirationtime: "2018-09-03 13:22:50",
          business: "XXX话术流程",
          remark: "XXX话术流程",
          state: "启用",
          operation: "buttom"
...
.main .main-left ul li:nth-child(1) {
  border-top: 1px solid #e4e8eb;
}
.main .main-left ul .list2 {
  height: 150px;
}
.main .main-left ul a {
  padding-left: 21%;
...
.main-left ul li .list-a {
  color: rgba(42, 54, 73, 1);
  font-size: 16px;
}
.main-left ul a i {
  margin-right: 10px;
